...
- **Cero código nativo que mantener** — la app ES https://conwayconquerors.com/play/.
...
bubblewrap init --manifest https://conwayconquerors.com/play/manifest.webmanifest
```

Respuestas sugeridas al asistente:
- **Domain**: conwayconquerors.com
...
`https://conwayconquerors.com/.well-known/assetlinks.json` responda el JSON.
...
`https://conwayconquerors.com/play/`, y el sitio genera el paquete Android (TWA)
...
https://conwayconquerors.com/play/ — pantalla completa, ícono propio, sin pasar por
